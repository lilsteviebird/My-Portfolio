...
class App extends Component {
  render() {
    ...
    <Layout>
        <Header className="header-color" title={<Link style={{textDecoration: 'none', color: 'white'}} to="/"><Button style ={{color: 'white',height: '100%', width: '100%'}}ripple>Home</Button></Link>} scroll>
            <Navigation>
